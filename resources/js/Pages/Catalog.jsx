...
export default function Catalog() {
    return (
        <>
            ...
            <div className="flex flex-wrap mx-14 my-20">
                <div>
                    <Card
                        className="my-8 mx-3 max-w-48 max-h-96 bg-[#f5a12c] dark:bg-[#8a440f]"
                        ...
                        <a href="#">
                            ...
                            <h6 className="text-xs font-normal tracking-tight text-[#6b3f00] dark:text-white">
                            Dibuat dengan sapi yang dibesarkan seperti anak sendiri.
                            </h6>
                        </a>
                        
                        <div className="flex items-center justify-between">
                            <span className="text-lg font-bold text-gray-900 dark:text-white">Rp75000,00</span>
                        </div>
                     </Card>
                </div>
                ...
                <div>
                    <Card
                        ...
                        <a href="#">
                            ...
                            <h6 className="text-xs font-normal tracking-tight text-[#7d7d7d] dark:text-white">
                            Dibuat dengan sapi yang dibesarkan seperti anak sendiri.
                            </h6>
                        </a>
